...
export const ReviewItem = ({ review, onDelete }: ReviewProps) => {
    ...
    return (
        <Card
            key={review.id}
            className="flex h-[340px] flex-shrink-0 items-start gap-2.5 p-5 w-full bg-[#0c0d27] rounded-lg overflow-hidden shadow-[4px_4px_4px_#00000040] border-0 relative"
        >
